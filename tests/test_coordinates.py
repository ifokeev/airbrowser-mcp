...
class TestScreenCoordinateTransform:
    ...
    def _create_mock_driver(self, win_x=0, win_y=0, win_w=1920, win_h=1080,
    ...
    def test_transform_no_offset_no_scale(self):
        ...
        driver = self._create_mock_driver(
            win_x=0, win_y=0, win_w=1920, win_h=1080,
            viewport_w=1920, viewport_h=1080
        )
    ...
    def test_transform_with_chrome_offset(self):
        ...
        driver = self._create_mock_driver(
            win_x=0, win_y=0, win_w=1920, win_h=1080,
            viewport_w=1920, viewport_h=900
        )

        coords = {
            "x": 500, "y": 300, "width": 100, "height": 50,
            "image_size": {"width": 1920, "height": 900}
        }
    ...
    def test_transform_with_window_position(self):
        ...
        driver = self._create_mock_driver(
            win_x=100, win_y=50, win_w=1920, win_h=1080,
            viewport_w=1920, viewport_h=1080
        )
    ...
    def test_transform_with_scale(self):
        ...
        coords = {
            "x": 250, "y": 150, "width": 50, "height": 25,
    ...
    def test_transform_wide_element_clicks_center(self):
        ...
        coords = {
            "x": 400, "y": 300, "width": 1112, "height": 50,
            "image_size": {"width": 1920, "height": 1080}
        }
...
class TestResponseParsing:
    ...
    def test_parse_valid_json_response(self):
        ...
        response = '{"found": true, "element": "button", "x": 100, "y": 200, "width": 50, "height": 30, "confidence": 0.95}'
...
class TestFractionalClickOffset:
    ...
    def test_fx_left_clicks_at_20_percent(self):
        ...
        coords = {
            "x": 400, "y": 300, "width": 1000, "height": 50,
            "image_size": {"width": 1920, "height": 1080}
        }
    ...
    def test_google_search_box_with_fx_02(self):
        ...
        coords = {
            "x": 659, "y": 555, "width": 1074, "height": 38,
            "image_size": {"width": 1912, "height": 837}
        }
