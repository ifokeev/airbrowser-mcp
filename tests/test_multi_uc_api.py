    ...
    try:
        ...
        try:
            ...
            if exec_result.success:
                h1_text = exec_result.data.result if exec_result.data else ""
                ...
                browser_client.take_screenshot(browser_id)
...
def test_concurrent_browsers_different_sites():
    ...
    try:
        ...
        for i, site in enumerate(sites):
            browser_config = BrowserConfig(window_size=[800, 600])
            ...
            nav_request = NavigateRequest(url=site)
            browser_client.navigate_browser(browser_id, payload=nav_request)
