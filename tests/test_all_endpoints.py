...
from airbrowser_client.exceptions import ApiException
...
@pytest.fixture(scope="module")
def health_client(api_client):
    """Create health API client."""
    return health_api.HealthApi(airbrowser_client.ApiClient(api_client))


@pytest.fixture(scope="module")
def pool_client(api_client):
    """Create pool API client."""
