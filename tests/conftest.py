...
# Note: Global cleanup removed to support parallel testing.
# Each test's browser_id fixture handles its own cleanup.
# Tests run in parallel with --dist loadscope (grouped by class/module).
