...
class DetectCoordinatesResult(BaseModel):
    ...
    data: Optional[DetectCoordinatesData] = Field(default=None, description="Detect response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": DetectCoordinatesData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
