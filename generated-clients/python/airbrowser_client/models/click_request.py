...
class ClickRequest(BaseModel):
    ...
    if_visible: Optional[StrictBool] = Field(default=False, description="Only click if element is visible")
    __properties: ClassVar[List[str]] = ["selector", "by", "timeout", "if_visible"]
