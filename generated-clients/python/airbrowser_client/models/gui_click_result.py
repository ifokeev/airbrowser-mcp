...
class GuiClickResult(BaseModel):
    """
    GuiClickResult
    """ # noqa: E501
    ...
    data: Optional[GuiClickData] = Field(default=None, description="GUI click response payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GuiClickData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
