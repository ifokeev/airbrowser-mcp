...
export interface CookiesRequest {
     ...
     * action
     */
    'action': CookiesRequestActionEnum;
    /**
     * cookie
     */
    'cookie'?: object;
...
export interface ExecuteCdpRequest {
    /**
     * method
     */
    'method': string;
...
export const BrowserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        cookies: async (browserId: string, payload: CookiesRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'browserId' is not null or undefined
            assertParamExists('cookies', 'browserId', browserId)
            // verify required parameter 'payload' is not null or undefined
            assertParamExists('cookies', 'payload', payload)
            const localVarPath = `/browser/{browser_id}/cookies`
                .replace(`{${"browser_id"}}`, encodeURIComponent(String(browserId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        executeCdp: async (browserId: string, payload: ExecuteCdpRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'browserId' is not null or undefined
            assertParamExists('executeCdp', 'browserId', browserId)
            // verify required parameter 'payload' is not null or undefined
            assertParamExists('executeCdp', 'payload', payload)
            const localVarPath = `/browser/{browser_id}/execute_cdp`
                .replace(`{${"browser_id"}}`, encodeURIComponent(String(browserId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const BrowserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async cookies(browserId: string, payload: CookiesRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GenericResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.cookies(browserId, payload, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BrowserApi.cookies']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async executeCdp(browserId: string, payload: ExecuteCdpRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GenericResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.executeCdp(browserId, payload, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BrowserApi.executeCdp']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const BrowserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        cookies(browserId: string, payload: CookiesRequest, options?: RawAxiosRequestConfig): AxiosPromise<GenericResponse> {
         ...
         * @throws {RequiredError}
         */
        executeCdp(browserId: string, payload: ExecuteCdpRequest, options?: RawAxiosRequestConfig): AxiosPromise<GenericResponse> {
...
export class BrowserApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public cookies(browserId: string, payload: CookiesRequest, options?: RawAxiosRequestConfig) {
        return BrowserApiFp(this.configuration).cookies(browserId, payload, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public executeCdp(browserId: string, payload: ExecuteCdpRequest, options?: RawAxiosRequestConfig) {
        return BrowserApiFp(this.configuration).executeCdp(browserId, payload, options).then((request) => request(this.axios, this.basePath));
    }
